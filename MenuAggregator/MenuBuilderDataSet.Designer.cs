...
namespace MenuAggregator {
    ...
    public partial class MenuBuilderDataSet : global::System.Data.DataSet {
        ...
        public partial class _MenuBuilder_WeeklyMenusDataTable : global::System.Data.TypedTableBase<_MenuBuilder_WeeklyMenusRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public _MenuBuilder_WeeklyMenusRow Add_MenuBuilder_WeeklyMenusRow(int Period, int Week, string Day, string Cafe, string conceptName, string menuItem, string Price, string Notes, System.DateTime dateEdit, string lastMenuItem, int isChanged, int isComplete) {
            ...
            private void InitClass() {
                ...
                this.columnisComplete = new global::System.Data.DataColumn("isComplete", typeof(int), null, global::System.Data.MappingType.Element);
        ...
        public partial class _MenuBuilder_WeeklyMenusRow : global::System.Data.DataRow {
            ...
            public int isComplete {
                get {
                    try {
                        return ((int)(this[this._tableMenuBuilder_WeeklyMenus.isCompleteColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
[MenuBuilder.BuiltCafes].Cafe = @Cafe";
    ...
    public partial class MenuBuilder_WeeklyMenusTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [MenuBuilder.WeeklyMenus] ([Period], [Week], [Day], [Cafe], [conceptName], [menuItem], [Price], [Notes], [dateEdit], [lastMenuItem], [isChanged], [isComplete]) VALUES (@Period, @Week, @Day, @Cafe, @conceptName, @menuItem, @Price, @Notes, @dateEdit, @lastMenuItem, @isChanged, @isComplete)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@isComplete", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "isComplete", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT PID, Period, Week, Day, Cafe, conceptName, menuItem, Price, Notes, dateEdi" +
                "t, lastMenuItem, isChanged, isComplete FROM [MenuBuilder.WeeklyMenus]";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Cafe, Day, Notes, PID, Period, Price, Week, conceptName, dateEdit, isChang" +
                "ed, lastMenuItem, menuItem, isComplete FROM [MenuBuilder.WeeklyMenus] WHERE (con" +
                "ceptName = @conceptName) AND (Period = @currentPeriod) AND (Week = @currentWeek)" +
                "";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT Cafe, Day, Notes, PID, Period, Price, Week, conceptName, dateEdit, isChang" +
                "ed, lastMenuItem, menuItem, isComplete FROM [MenuBuilder.WeeklyMenus] WHERE (Caf" +
                "e = @Cafe) AND (isChanged = 1)";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Cafe", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "Cafe", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "SELECT TOP (1) Period, Week, isComplete FROM [MenuBuilder.WeeklyMenus] WHERE (con" +
                "ceptName = @conceptName) ORDER BY Period DESC, Week DESC";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@conceptName", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "conceptName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[4] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[4].Connection = this.Connection;
            this._commandCollection[4].CommandText = "SELECT Cafe, Day, Notes, PID, Period, Price, Week, conceptName, dateEdit, isChang" +
                "ed, lastMenuItem, menuItem, isComplete FROM [MenuBuilder.WeeklyMenus] WHERE (Caf" +
            ...
            this._commandCollection[6].CommandText = "UPDATE MenuBuilder.WeeklyMenus\r\nSET isComplete = @isComplete\r\nWHERE menuItem = @m" +
                "enuItem AND Period = @period AND Week = @week";
            this._commandCollection[6].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[6].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@isComplete", global::System.Data.SqlDbType.Variant, 1024, global::System.Data.ParameterDirection.Input, 0, 0, "isComplete", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[6].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@menuItem", global::System.Data.SqlDbType.Variant, 1024, global::System.Data.ParameterDirection.Input, 0, 0, "", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._commandCollection[6].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@period", global::System.Data.SqlDbType.Variant, 1024, global::System.Data.ParameterDirection.Input, 0, 0, "", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._commandCollection[6].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@week", global::System.Data.SqlDbType.Variant, 1024, global::System.Data.ParameterDirection.Input, 0, 0, "", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillComboBox(MenuBuilderDataSet._MenuBuilder_WeeklyMenusDataTable dataTable, string conceptName, global::System.Nullable<int> currentPeriod, global::System.Nullable<int> currentWeek) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((conceptName == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual MenuBuilderDataSet._MenuBuilder_WeeklyMenusDataTable GetDataBy3(string conceptName, global::System.Nullable<int> currentPeriod, global::System.Nullable<int> currentWeek) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((conceptName == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int GetLastWeek(MenuBuilderDataSet._MenuBuilder_WeeklyMenusDataTable dataTable, string conceptName) {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            if ((conceptName == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual MenuBuilderDataSet._MenuBuilder_WeeklyMenusDataTable GetDataBy4(string conceptName) {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            if ((conceptName == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(global::System.Nullable<int> Period, global::System.Nullable<int> Week, string Day, string Cafe, string conceptName, string menuItem, string Price, string Notes, global::System.Nullable<global::System.DateTime> dateEdit, string lastMenuItem, global::System.Nullable<int> isChanged, global::System.Nullable<int> isComplete) {
            if ((Period.HasValue == true)) {
            ...
            if ((lastMenuItem == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[9].Value = ((string)(lastMenuItem));
            }
            if ((isChanged.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[10].Value = ((int)(isChanged.Value));
            }
            else {
                this.Adapter.InsertCommand.Parameters[10].Value = global::System.DBNull.Value;
            }
            if ((isComplete.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[11].Value = ((int)(isComplete.Value));
            }
            else {
        ...
        public virtual int UpdateQuery(object isComplete, object menuItem, object period, object week) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[6];
            if ((isComplete == null)) {
                throw new global::System.ArgumentNullException("isComplete");
            }
            else {
                command.Parameters[0].Value = ((object)(isComplete));
            }
            if ((menuItem == null)) {
                throw new global::System.ArgumentNullException("menuItem");
            }
            else {
                command.Parameters[1].Value = ((object)(menuItem));
            }
            if ((period == null)) {
                throw new global::System.ArgumentNullException("period");
            }
            else {
                command.Parameters[2].Value = ((object)(period));
            }
            if ((week == null)) {
                throw new global::System.ArgumentNullException("week");
            }
            else {
                command.Parameters[3].Value = ((object)(week));
            }
